...
RMDIR /S /Q "%engine_folder%/vulkan/out_dev/"

MKDIR "%engine_folder%/vulkan/out_dev/"
...
C:/msys64/mingw64/bin/g++.exe ^
    ...
    -g ^
    -c ^
    %engine_folder%/vulkan/vulkan.cpp ^
    -o ^
    %engine_folder%/vulkan/out_dev/vulkan.o ^
    -L ^
...
C:/msys64/mingw64/bin/g++.exe ^
    ...
    -g ^
    -c ^
    %engine_folder%/vulkan/vulkan.access.cpp ^
    -o ^
    %engine_folder%/vulkan/out_dev/vulkan.access.o ^
    -L ^
    C:/VulkanSDK/1.3.236.0/Lib ^
    -l:vulkan-1.lib ^
    -L ^
...
cd C:/Users/Kronark/Documents/GitHub/Graphics/src/engine/vulkan
