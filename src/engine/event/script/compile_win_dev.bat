...
RMDIR /S /Q "%engine_folder%/event/out_dev/"

MKDIR "%engine_folder%/event/out_dev/"
...
C:/msys64/mingw64/bin/g++.exe ^
    ...
    -g ^
    -c ^
    %engine_folder%/event/event.cpp ^
    -o ^
    %engine_folder%/event/out_dev/event.o ^
    -L ^
...
C:/msys64/mingw64/bin/g++.exe ^
    ...
    -g ^
    -c ^
    %engine_folder%/event/event.access.cpp ^
    -o ^
    %engine_folder%/event/out_dev/event.access.o ^
    -L ^
    C:/VulkanSDK/1.3.236.0/Lib ^
    -l:vulkan-1.lib ^
    -L ^
...
cd C:/Users/Kronark/Documents/GitHub/Graphics/src/engine/event