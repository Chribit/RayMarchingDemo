...
RMDIR /S /Q "%engine_folder%/memory/out_dev/"

MKDIR "%engine_folder%/memory/out_dev/"
...
C:/msys64/mingw64/bin/g++.exe ^
    ...
    -g ^
    -c ^
    %engine_folder%/memory/memory.cpp ^
    -o ^
    %engine_folder%/memory/out_dev/memory.o ^
    -L ^
...
C:/msys64/mingw64/bin/g++.exe ^
    ...
    -g ^
    -c ^
    %engine_folder%/memory/memory.access.cpp ^
    -o ^
    %engine_folder%/memory/out_dev/memory.access.o ^
    -L ^
    C:/VulkanSDK/1.3.236.0/Lib ^
    -l:vulkan-1.lib ^
    -L ^
...
cd C:/Users/Kronark/Documents/GitHub/Graphics/src/engine/memory