...
RMDIR /S /Q "%engine_folder%/compact/out_dev/"

MKDIR "%engine_folder%/compact/out_dev/"
...
C:/msys64/mingw64/bin/g++.exe ^
    ...
    -g ^
    -c ^
    %engine_folder%/compact/compact.cpp ^
    -o ^
    %engine_folder%/compact/out_dev/compact.o ^
    -L ^
...
cd C:/Users/Kronark/Documents/GitHub/Graphics/src/engine/compact
