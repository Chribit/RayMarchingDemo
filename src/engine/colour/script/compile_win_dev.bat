...
RMDIR /S /Q "%engine_folder%/colour/out_dev/"

MKDIR "%engine_folder%/colour/out_dev/"
...
C:/msys64/mingw64/bin/g++.exe ^
    ...
    -g ^
    -c ^
    %engine_folder%/colour/colour.cpp ^
    -o ^
    %engine_folder%/colour/out_dev/colour.o ^
    -L ^
...
cd C:/Users/Kronark/Documents/GitHub/Graphics/src/engine/colour
