...
RMDIR /S /Q "%engine_folder%/structure/out_dev/"
...
C:/msys64/mingw64/bin/g++.exe ^
    ...
    -g ^
    -c ^
    %engine_folder%/structure/structure.access.cpp ^
    -o ^
    %engine_folder%/structure/out_dev/structure.access.o ^
    -L ^
    C:/VulkanSDK/1.3.236.0/Lib ^
    -l:vulkan-1.lib ^
    -L ^
...
cd C:/Users/Kronark/Documents/GitHub/Graphics/src/engine/structure